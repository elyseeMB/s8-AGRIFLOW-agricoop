...
Navigation (7 modules existants) : Tableau de bord, Membres, Livraisons, Paiements, Ventes & Stock, Statistiques, Comptes les icons qui sont dans la sections layouts dans l'exemple.
